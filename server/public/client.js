  ...
  ws.addEventListener('message', (event) => {
    ...
    switch (msg.type) {
      case 'status':
        ...
        break;
      case 'transcript':
        appendTranscriptLine(msg.payload.text, msg.payload.isFinal, msg.payload.language);
        break;
      case 'reprompt':
        showBanner(msg.message, 'warn');
        break;
      case 'escalate':
        showBanner(
          `Escalated to ${msg.reason === '911' ? 'emergency services' : 'a human operator'}.`,
          'escalate'
        );
        stop();
        break;
